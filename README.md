...
| **立绘切换** | `卷王鹿端午` / `鹿医师端午` / `雨木木鹿端午` / `王美嘉鹿端午` 等 | **按职业**切换 · 八职业端午须活动解锁 · **番外端午免费** |
...
| 立绘 | 解锁条件 | 说明 |
|------|----------|------|
| 🔥 卷王鹿·端午 | 活动期间 **自🦌 累计 10 次** | 达标自动赠送 |
| 💊 鹿医师·端午 | 活动期间 **帮鹿 累计 10 次** | 达标自动赠送 |
| 👑 王美嘉鹿·端午 / 🌧️ 雨木木鹿·端午 | **免费** | `王美嘉鹿端午` / `雨木木鹿端午` 随时切换 · 默认不穿皮肤 |

八职业活动结束后 **不可再解锁** 端午立绘；番外端午立绘 **始终免费**。已获得的立绘 **永久保留**。界面端午主题仍可通过 `鹿皮肤端午` 随时免费切换。
...
与八职业 **互斥转职**，配额与天赋独立；详见「鹿职业」第二张番外一览图。

| 番外 | 转职 | 看静态卡 | 专属技 | 关键数值 |
|------|------|----------|--------|----------|
| 👑 王美嘉鹿 | `转职王美嘉` | `鹿职业卡王美嘉` | `组队@` | 帮鹿 **6** · 帮戒 **2** · 组队联动每日 **≤5** 次（净值≥0）· 不可戒鹿 |
| 🌧️ 雨木木鹿 | `转职雨木木` | `鹿职业卡雨木木` | `束缚@` | 帮鹿 **18** · 帮戒 **3** · 帮鹿 **40%** 挂「阳痿」· 束缚 **55 分钟**（仅 **11:00 前**） |

雨木木 **端午立绘免费**，随时 `雨木木鹿端午` / `雨木木鹿默认` 切换（默认不穿皮肤）。
...
端午立绘（`skins/duanwu/`）— **八职业活动解锁 · 番外免费**，非界面主题：

| 立绘 | 条件 |
|------|------|
| 卷王鹿·端午 | 端午活动期间自🦌 **累计 10 次** |
| 鹿医师·端午 | 端午活动期间帮鹿 **累计 10 次** |
| 王美嘉鹿·端午 / 雨木木鹿·端午 | **免费** · `王美嘉鹿端午` / `雨木木鹿端午` |

八职业活动结束后不可再解锁；番外随时切换。切换：`卷王鹿端午` / `鹿医师端午`（须已解锁）· `雨木木鹿端午` 等。
