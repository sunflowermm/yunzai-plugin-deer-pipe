...
export const HELP_SECTIONS = {
    ...
    playful: {
        ...
        items: [
            ...
            { cmd: `连抽${D_SHOW}签`, desc: '自动抽签至配额用尽', quota: '过程发聊天记录' },
        ],
    },
    profession: {
        title: '每日鹿职业',
