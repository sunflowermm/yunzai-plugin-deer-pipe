...
export const HELP_SECTIONS = {
    base: {
        ...
        items: [
            ...
            { cmd: `连${D_SHOW}`, desc: '单人自动连🦌直至鹿死', quota: '过程发聊天记录 · 须已转职 · 鹿车发/帮鹿位不可用' },
    ...
    friends: {
        ...
        items: [
            ...
            { cmd: `连${D_SHOW}福@ta`, desc: '叠层/续回合至配额用尽（满层只续 bleR）', quota: '过程发聊天记录 · 发车位不可用' },
    ...
    playful: {
        ...
        items: [
            ...
            { cmd: `连${D_SHOW}咒@ta`, desc: '叠层/续回合至配额用尽（满层只续 curR）', quota: '过程发聊天记录 · 须🦌友 · 发车位不可用' },
            ...
            { cmd: `催${D_SHOW} / 催${D_SHOW}@ta`, desc: '叠催更符（任意次数均可 · 可与鹿福共存）· 带咒者咒回合 -1', quota: `${DAILY_URGE_QUOTA} 次/日 · 无@则自催` },
            { cmd: `连催${D_SHOW} / 连催${D_SHOW}@ta`, desc: '自动催至配额用尽 · 叠层催更符', quota: '过程发聊天记录 · 无@则自催 · 鹿车发车位不可用' },
            { cmd: '诈戒 / 诈戒鹿', desc: '嘴上戒🦌，实际 +1', quota: `${DAILY_FAKE_WITHDRAW_QUOTA} 次/日` },
            { cmd: '连诈戒', desc: '自动诈戒至配额用尽', quota: '过程发聊天记录 · 鹿车发车位不可用' },
            ...
            { cmd: `连${D_SHOW}鸣`, desc: '活人须带咒：逐次震咒至清；鹿死鸣魂至配额用尽', quota: '咒清即停 · 发车位不可用 · 过程发聊天记录' },
            ...
            { cmd: `连抽${D_SHOW}签`, desc: '自动抽签至配额用尽', quota: '过程发聊天记录 · 鹿车发车位不可用' },
        ],
    },
    profession: {
        title: '每日鹿职业',
    ...
    eco: {
        ...
        items: [
            ...
            { cmd: '机制·催更符', desc: '任意次数均可叠层 · 安全自🦌/被帮一次性 +N · 可与鹿福共存', quota: '催带咒目标 = 咒回合 -1 · 连催可快速叠层' },
    ...
    death: {
        ...
        items: [
            ...
            { cmd: `连冥${D_SHOW}咒@ta`, desc: '叠层/续回合至配额用尽', quota: '过程发聊天记录 · 鹿死专属' },
            ...
            { cmd: `连托梦${D_SHOW}@🦌友`, desc: '缓咒/贴催更符至配额用尽', quota: '过程发聊天记录 · 须🦌友' },
            ...
            { cmd: '连还阳签', desc: '自动抽至还阳或配额用尽', quota: '过程发聊天记录 · 还阳成功附鹿况图' },
