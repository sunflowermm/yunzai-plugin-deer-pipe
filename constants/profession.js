...
export const PROFESSIONS = {
    ...
    medic: {
        ...
        helpQuotaBonusChance: 0.08,
        helpQuotaSaveChance: 0.30,
    },
    ascetic: {
        id: 'ascetic',
        name: '戒灵师',
    ...
    sunflower: {
        ...
        weatherPositiveAmp: 1.40,
        blessApplyBonus: 0.16,
        helpBlessChance: 0.32,
        helpCurseCleanseChance: 0.28,
        lotteryLuckDelta: 0.15,
        /** 催鹿/中签贴符时额外 +1 层 */
        urgeCastStackBonus: 1,
        /** 自🦌兑现催更符时额外 +1 次 */
        urgeBuffConsumeBonus: 1,
        helpQuotaSaveChance: 0.12,
    },
};
...
export const PROFESSION_SKILLS = {
    ranger: {
        ...
        name: '天象巡游',
        cmd: '鹿巡',
        desc: '下一次玩法天象正向 ×1.42 · 下一次抽鹿签吉运 +8% · 当日鹿签 +1 · 1 次/日',
    },
    medic: {
        id: 'medic',
        name: '妙手愈鹿',
        cmd: '愈鹿@ / 鹿愈@',
        desc: '不占帮鹿配额 · 0% 失手 · 帮 +1/救活 · 必清咒贴福 · 当日帮鹿 +1 · 1 次/日',
    },
    ascetic: {
        id: 'ascetic',
        name: '清规戒律',
        cmd: '清规@',
        desc: '不占帮戒配额 · 0% 失手 · 帮戒 -2 · 当日帮戒 +1 · 1 次/日',
    },
    grinder: {
        id: 'grinder',
        name: '卷王冲锋',
        cmd: '卷王冲 / 卷冲',
        desc: '强制安全自鹿 +2 · 下一次超限自🦌鹿死 -18% · 当日擂台 +1 · 1 次/日',
    },
    curser: {
        id: 'curser',
        name: '咒缚',
        cmd: '咒缚@',
        desc: '不占鹿咒配额 · 叠咒/满层续回合 · 当日鹿咒 +1 · 1 次/日',
    },
    blesser: {
        id: 'blesser',
        name: '广福',
        cmd: '广福@',
        desc: '不占鹿福配额 · 贴福 · 带咒先撕 1 层 · 当日鹿福 +1 · 1 次/日',
    },
    rogue: {
        id: 'rogue',
        name: '夜袭',
        cmd: '夜袭@',
        desc: '不占偷鹿配额 · 88% 偷 1 · 失手不扣次 · 当日偷鹿 +1 · 1 次/日',
    },
    sunflower: {
        id: 'sunflower',
        name: '向阳',
        cmd: '向阳@',
        desc: '不占催鹿/鹿福配额 · 催更 +2 · 贴 2 层福 · 清咒 · 滋养 +1 · 当日催鹿/鹿福各 +1 · 1 次/日',
    },
};
